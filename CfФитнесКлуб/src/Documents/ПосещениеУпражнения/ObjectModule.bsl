...
Процедура ОбработкаПроведения(Отказ,Режим)
	...
	КоличествоПосещенийВБилете = 1/Выборка.КоличествоПосещенийОстаток;
	Движение.Сумма = (СуммаДокументаБилет/100)*ПроцентТренеруУпражнениеПосещение*КоличествоПосещенийВБилете;
	
	// регистр ПосещениеУпражнений
	Движения.ПосещениеУпражнений.Записывать = Истина;
	ДвижениеПосещениеУпражнений = Движения.ПосещениеУпражнений.Добавить();
	ДвижениеПосещениеУпражнений.Период = Дата;
	ДвижениеПосещениеУпражнений.Упражнение = Упражнение;
	ДвижениеПосещениеУпражнений.Клиент = КлиентПоОснованию();
	ДвижениеПосещениеУпражнений.Количество = 1;
...
Функция АктивныеПосещения()
	...
	Запрос.Текст = 
		...
		|	И ВидУпражнения = &ВидУпражнения) КАК АктивныеПосещенияОстатки";
		
	Запрос.УстановитьПараметр("Основание", Билет);
	Запрос.УстановитьПараметр("ВидУпражнения", Упражнение.ВидУпражнения);	
...
Функция КлиентПоОснованию()
	...
	Запрос.УстановитьПараметр("Ссылка", Билет);
